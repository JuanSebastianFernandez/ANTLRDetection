...
public class ExternalDependencyWatcher extends Object implements Closeable, OtraInterfaz {

    final private static Set<FileWatcher> watchers = new HashSet<>();
    @Deprecated
    private static final String NOMBRE = "Ejemplo";
    private transient int contador;
    volatile boolean estaActivo;
...
@SuppressWarnings("deprecation")
    ...
    public abstract boolean watchAndCopy(File watchFolder, File targetFolder) {
